...
export default function Experiments() {
  return (
    <div style={{
      ...
      <FlaskConical size={24} color={color.textLight} strokeWidth={1.2} style={{ marginBottom: '12px' }} />
      ...
      <div style={{ fontSize: size.sm, color: color.textLight, lineHeight: 1.5 }}>
        Compare scores across models and configs. Coming after first benchmark run.
      </div>
    </div>
  )
}
